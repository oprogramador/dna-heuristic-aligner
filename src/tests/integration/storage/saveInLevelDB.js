...
describe('saveInLevelDB', () => {
  ...
  it('saves a string', () => {
    ...
    return saveInLevelDB(testDbDirectory)(key, value)
      .then(() => {
  ...
  it('saves an array', () => {
    ...
    return saveInLevelDB(testDbDirectory)(key, ['foo', 'bar', 'baz'])
      .then(() => {
        db = LevelPromise(levelup(testDbDirectory));
  ...
  it('saves an object', () => {
    ...
    return saveInLevelDB(testDbDirectory)(key, { bar: 'bar-value', baz: 'baz-value', foo: 'foo-value' })
      .then(() => {
        db = LevelPromise(levelup(testDbDirectory));
  ...
  it('saves nested objects', () => {
    ...
    return saveInLevelDB(testDbDirectory)('aRootKey', objects)
      .then(() => {
        db = LevelPromise(levelup(testDbDirectory));
